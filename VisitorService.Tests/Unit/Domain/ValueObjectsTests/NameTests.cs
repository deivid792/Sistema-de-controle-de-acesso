...
*/
        ...
        public void should_add_notifications_with_fewer_than_2_characters()
        {
            ...
            Assert.True(name.HasErrors);
            Assert.Contains(name.Errors, n => n.Message == "A quantidade mínima de caracteres é 2");
        }
        [Fact]
        public void should_add_notifications_with_fewer_than_100_characters()
        {
            ...
            Assert.True(name.HasErrors);
            Assert.Contains(name.Errors, n => n.Message == "A quantidade máxima de caracteres é 100");
        }
    }
}